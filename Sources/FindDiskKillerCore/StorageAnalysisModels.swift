...
public struct StorageSourceID: RawRepresentable, Codable, Hashable, Identifiable, Sendable {
    ...
    public static let gradle = Self(rawValue: "gradle")
    public static let androidSDK = Self(rawValue: "androidSDK")
    public static let flutter = Self(rawValue: "flutter")
    public static let cocoaPods = Self(rawValue: "cocoaPods")
    public static let homebrew = Self(rawValue: "homebrew")
    public static let rust = Self(rawValue: "rust")
    public static let toolCaches = Self(rawValue: "toolCaches")
